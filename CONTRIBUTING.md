...
This project has several build dependencies. On Ubuntu, you can install these dependencies from the top of the source tree using the apt command as follows:
